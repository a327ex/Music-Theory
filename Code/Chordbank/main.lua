...
--[[
  Creates function buttons, which change between the application's main functions:
    Harmonic Field - a list of keys, and in each key all chord's in its harmonic field (in all modes) are shown in a grid
    Chord to Key and Modes - the reverse of the above function, this one shows a list of all keys and modes that a particular chord appears in
    Secondary Chords - shows
